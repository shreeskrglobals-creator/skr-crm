...
# Custom Title and Theme Styling (Fixed spelling parameters here)
st.markdown("""
    <style>
...
country_logistics = {
    ...
    "Australia": {"active_days": "Monday to Friday", "peak_ist_start": time(4, 30), "peak_icon": "🇦🇺", "peak_ist_end": time(12, 30), "best_channel": "WhatsApp / Call", "status_now": "Earliest market to follow up with."},
